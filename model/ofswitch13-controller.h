...
struct AuxConn
{
	Ipv4Address aux_sw_ipv4;                 //!< Switch IPv4 address
	Ptr<Socket> aux_socket;               //!< socket connected to controller, can be TCP/UDP
	uint16_t aux_sw_port;                    //!< socket switch port
	Ipv4Address aux_ctrl_ipv4;            //!< controller ipv4 address
	uint16_t aux_ctrl_port;               //!< controller port
...
public:
   ...
   */
  void RegisterConnection (uint8_t auxID, uint64_t datapathID, Ipv4Address source);
